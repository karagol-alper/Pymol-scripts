...
select mutation_PAT,chain A AND 395+148+213+519+12+18+93+101+269+472+613+703+247+435+686+673+
711/c;
...
select mutation_MOD,chain A AND 348+622+487+407+496/c;
show spheres, mutation_MOD;
set sphere_scale, 1, mutation_MOD;
color yellow,mutation_MOD;
deselect

select mutation_MILD,chain A AND 302+517+46+212+255+540+376+257+352+380/c;
